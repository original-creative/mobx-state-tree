;(function (global, factory) {
    ...
    */
        ...
        return args
            .reduce(function (prev, cur) {
                return prev.cloneAndEnhance({
                    ...
                    preProcessor: function (snapshot) {
                        return cur.applySnapshotPreProcessor(
                            prev.applySnapshotPreProcessor(snapshot)
                        )
                    },
                    postProcessor: function (snapshot) {
                        return cur.applySnapshotPostProcessor(
    ...
    function refinement() {
        ...
        var name =
            typeof args[0] === "string" ? args.shift() : isType(args[0]) ? args[0].name : null
        var type = args[0]
    ...
    function late(nameOrType, maybeType) {
        var name =
            typeof nameOrType === "string" ? nameOrType : "late(" + nameOrType.toString() + ")"
    ...
    var Frozen = /** @class */ (function (_super) {
        ...
        function Frozen(subType) {
            var _this =
                _super.call(this, subType ? "frozen(" + subType.name + ")" : "frozen") || this
            ...
            value: function (storedRefNode, identifier, customGetSet) {
                ...
                if (storedRefNode.state === NodeLifeCycle.FINALIZED) {
                    ...
                    if (!storedRefNode.isRoot) {
                        ...
                        storedRefNode.root.registerHook(
