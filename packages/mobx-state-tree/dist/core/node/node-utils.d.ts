...
/** @hidden */
export declare type TypeOfValue<T extends IAnyStateTreeNode> = T extends IStateTreeNode<infer IT>
    ? IT
    : never
/**
 ...
 */
export declare function isStateTreeNode<IT extends IAnyComplexType = IAnyComplexType>(
    value: any
