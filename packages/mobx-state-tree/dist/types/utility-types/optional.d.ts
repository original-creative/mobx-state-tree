...
/** @hidden */
export declare type OptionalDefaultValueOrFunction<IT extends IAnyType> =
    | IT["CreationType"]
    | IT["SnapshotType"]
...
export interface IOptionalIType<IT extends IAnyType, OptionalVals extends ValidOptionalValues>
    extends IType<
        ...
        IT["TypeWithoutSTN"]
    > {}
export declare function optional<IT extends IAnyType>(
    type: IT,
    defaultValueOrFunction: OptionalDefaultValueOrFunction<IT>
): IOptionalIType<IT, [undefined]>
export declare function optional<IT extends IAnyType, OptionalVals extends ValidOptionalValues>(
    type: IT,
    defaultValueOrFunction: OptionalDefaultValueOrFunction<IT>,
