...
export declare type OnReferenceInvalidated<STN extends IAnyStateTreeNode> = (
    event: OnReferenceInvalidatedEvent<STN>
) => void
/** @hidden */
export declare type ReferenceT<IT extends IAnyType> = IT["TypeWithoutSTN"] &
...
export declare type ReferenceOptions<IT extends IAnyComplexType> =
 ...
 */
export declare function reference<IT extends IAnyComplexType>(
    subType: IT,
...
export declare function safeReference<IT extends IAnyComplexType>(
    subType: IT,
